...
Gui, new, +hwndhMainWindow +Resize
Gui Show, w700 h600, Window
Preview := new Thumbnail(hMainWindow, 0x000104FA)
Preview.SetRegion(1, 1, 699, 599, 1, 1, 699, 599)
Preview.Show()
/*
What to do:
...
GuiSize:
Preview.SetRegion(0, 0, A_ScreenWidth, A_ScreenHeight, 0, 0, A_ScreenWidth, A_ScreenHeight)
return
